...
toc: true
slug: read-func
description: "A reusable function to iteratively read in data files."
image: "purrr_thumbnail.png"
categories:
  - Programming
  - R
---
...
In my [phthalates exposure projects](/posts/phthalates-i/), I imported 21 text files for tidying and analysis. This is clearly a task well-suited for a function, but instead, I tediously copied and pasted code 21 times. Why? Honestly, I just didn't have much experience writing functions and I was too eager to get data into R to actually sit down and figure out how to automate it. 
...
```{r}
files = list.files("../phthalates-i/data/")
files
length(files)

...
As the authors suggest, it takes a little while to earn the rules of regexps and get comfortable using them, but once you do, you'll find them to be a powerful tool in your data cleaning toolbox. The best resources I found for learning and practicing regexps are the RStudio `stringr` cheatsheet (found [here](https://github.com/rstudio/cheatsheets/blob/main/strings.pdf)) and this handy interactive [program](https://regexlearn.com/). 
...
tall_table_2 <- 
  ...
  rename(ht_in_cm = metric)
  
tall_table_2$ht_in_cm
